const project = [
  {
    ...
    desc:
      "A practice begining website, I decided to do a tribute to Tribute, the song by Tenacious D. This was the first part of the freeCodeCamp.org HTML/CSS certificate.",
  },
  {
    id: 2,
    title: "Unnescessary",
  ...
  },
  {
    ...
    desc:
      "A simple app that switches the background color when you flip a switch. Fun learning how to manipulate the DOM and use jQuery.",
  },
  {
    id: 4,
    title: "Counter App",
    ...
    desc:
      "More practice manipulating the DOM. Count when a button is clicked and changes the counter color depending on if it is negative or positive.",
  },
  {
    ...
    desc:
      "Practice switching back and forth between different elements or an array containing different reviews. And a random button that selects a review at random.",
  },
  {
    title: "Questions App",
    category: "JavaScript",
    ...
    desc:
      "Simple app that expands to reveal the anser to the questions below, and only one is open above. Look above at my 'About' section to check it out in action in a different setting.",
  },
  {
    ...
    desc:
      "Made a pretty nifty little modal container, one of the nifty things that you click on and it darkens the background to bring the subject into focus a little more.",
  },
  {
    title: "Menu App",
    category: "JavaScript",
    ...
    desc:
      "An interactive menu for a fictitious restraunt. All menu items, as well as the menu button labels, are loaded from an array of objects.",
  },
  {
...
function displayProjectItems(projectItems) {
  ...
  projectCenter.innerHTML = displayProjects;
}
